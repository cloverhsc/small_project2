...
import { TransformBooleanPipe } from './dashboard/transform-boolean.pipe';
import { BloodPressureComponent } from './dashboard/physiological/customer-physinfo/blood-pressure/blood-pressure.component';
